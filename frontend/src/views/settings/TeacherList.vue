<template>
  <div class="bg-white border border-gray-200 rounded shadow-sm">
    <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center">
          ...
          <div>
            <h3 class="text-sm font-semibold text-gray-900">教师列表</h3>
            <p class="text-xs text-gray-500 mt-0.5">共 {{ teachers.length }} 位教师</p>
          </div>
        </div>
        <div class="relative">
          <input
    ...
    <div v-if="teachers.length === 0" class="p-12 text-center">
      <svg class="w-12 h-12 mx-auto mb-3 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
      <p class="text-sm text-gray-500 font-medium">暂无教师</p>
      <p class="text-xs text-gray-400 mt-1">请在上方添加新教师</p>
    </div>
          ...
          <div class="flex items-start space-x-3 flex-1 min-w-0">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 mb-1.5">
                <h4 class="text-sm font-semibold text-gray-900">{{ teacher.name }}</h4>
