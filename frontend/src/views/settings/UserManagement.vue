<template>
  <div class="bg-white border border-gray-200 rounded shadow-sm">
    <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center">
          ...
          <div>
            <h3 class="text-sm font-semibold text-gray-900">用户列表</h3>
            <p class="text-xs text-gray-500 mt-0.5">共 {{ users.length }} 位用户</p>
          </div>
        </div>
        <div class="relative">
          <input
    ...
    <div v-else-if="filteredUsers.length === 0" class="p-12 text-center">
      ...
      <p class="text-sm text-gray-500 font-medium">暂无用户</p>
    </div>
